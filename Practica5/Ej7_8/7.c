...
int main()
{
    ...
    printf("---IMPRIMIR PRORDER---\n");
    preorder(arbolBinarioDeNumeros);
    printf("---IMPRIMIR POSTORDER---\n");
    postorder(arbolBinarioDeNumeros);
    printf("\n");
    printf("\n");
    printf("---IMPRIMIR POR NIVEL 0---\n");
    porNivel(arbolBinarioDeNumeros,0);
    printf("---IMPRIMIR POR NIVEL 1---\n");
    porNivel(arbolBinarioDeNumeros,1);
    printf("---IMPRIMIR POR NIVEL 2---\n");
    porNivel(arbolBinarioDeNumeros,2);
    printf("---IMPRIMIR POR NIVEL 3---\n");
    porNivel(arbolBinarioDeNumeros,3);
 	printf("---IMPRIMIR POR NIVEL 4---\n");
    porNivel(arbolBinarioDeNumeros,4);
    printf("---IMPRIMIR POR NIVEL 5---\n");
